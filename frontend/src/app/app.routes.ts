...
import { Classifica } from './components/leaderboard/leaderboard';
import { Storico } from './components/history/history';
import { DettaglioStorico } from './components/history-detail/history-detail';
import { authGuard } from './guards/auth-guard';

export const routes: Routes = [
  { path: '', redirectTo: 'home', pathMatch: 'full' },
  { path: 'home', component: Home, title: 'WikiBlank' },
  { path: 'leaderboard', component: Classifica, title: 'Classifica | WikiBlank' },
